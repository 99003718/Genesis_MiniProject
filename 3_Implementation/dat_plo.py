...
data2 = pd.read_excel(r'''F:\Document\GitHub\AppliedSDLC_C1\3_Implementation\data_test\postsurvey.xlsx''')
data3 = pd.read_excel(r'''F:\Document\GitHub\AppliedSDLC_C1\3_Implementation\data_test\pretest.xlsx''')
data4 = pd.read_excel(r'''F:\Document\GitHub\AppliedSDLC_C1\3_Implementation\data_test\posttest.xlsx''')
...
def auto_co_plotting(y_lst, y, a, x_lst=x_lst_all):
    ...
    plt.title(a)
    try:
        path = f"F://Document//GitHub//AppliedSDLC_C1//3_Implementation//{y}"
